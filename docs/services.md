...
### *Install*
install ddclient [Github](https://github.com/ddclient/ddclient)
...
if not try adding at the top of your configfile found at ```/etc/ddclient.conf```
```
zone=yourmaindomain.com
```
